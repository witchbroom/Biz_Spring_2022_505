...
public class HomeController {
	...
	public String home(Model model, @RequestParam(name = "pageno", required = false, defaultValue = "0") int pageno, SearchPage searchPage) {
	 ...
	 * tiles가 작동되어 layout 만들고 rendering하여 응답을 한다
	 * 
